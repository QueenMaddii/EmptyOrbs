...
import emptyorbsmod.util.GeneralUtils;
import emptyorbsmod.util.KeywordInfo;
...
@SpireInitializer
public class EmptyOrbsMain implements
    ...
    //todo
    private static final String resourcesFolder = "emptyorbsmod";
...
//                localizationPath(lang, "UIStrings.json"));
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(EmptyOrbsMain.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
